...
| `finish_reason: length` в ndjson | поле отсутствует в этом формате stream-json вообще (0 совпадений на обоих плечах) — метрика недоступна в этом виде вывода | то же |
